...
## {{< fa spell-check >}} Terminology
### Check Yourself!

::: {.callout-tip}
## **Check Yourself**

For each of the following quantities, classify them as either a statistic or a population parameter and, consequently, as random or deterministic. 

::: {.nonincremental}
a)  The average commute time (in minutes) among all UCSB students.
b)  The maximum height among a sample of 10 coconut trees.
c)  The standard devaition among the heights of all US citizens.
d)  The proportion of FIV-positive cats currently housed at the Santa Barbara Humane Society.
:::
:::
